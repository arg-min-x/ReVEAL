...
W = nd_dwt_4D('db1',[A.frame_size(1),A.frame_size(2),A.frame_size(3),A.Q],'pres_l2_norm',1,'compute','gpu');
k = 5;
...
while ~stop
    ...
    alphares = W.dec(reshape(alphares,[A.frame_size(1),A.frame_size(2),A.frame_size(3),A.Q]),1);
